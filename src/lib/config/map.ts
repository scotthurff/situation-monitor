...
export const HOTSPOTS: Hotspot[] = [
	...
	},
	{
		...
		lon: 51.4,
		level: 'critical',
		desc: 'Tehran — Nuclear program, regional tensions, US sanctions'
	},
	{
		name: 'Tel Aviv',
		lat: 32.07,
	...
	},
	{
		...
		lon: -66.9,
		level: 'high',
		desc: 'Caracas — Venezuela crisis, Maduro regime, US sanctions'
	},
	{
		name: 'Nuuk',
		lat: 64.18,
		lon: -51.72,
		level: 'elevated',
		desc: 'Nuuk — Greenland, US acquisition interest, Arctic strategy'
	}
];
